...
import { EthereumProvider, ProviderConnectInfo, ProviderMessage, ProviderRpcError, RequestArguments } from './ethereum_provider';
...
export declare class WalletProvider implements EthereumProvider {
    ...
    addEthersWallet(wallet: Wallet): EthAddress;
